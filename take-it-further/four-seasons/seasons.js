autumn.addEventListener('click',function(){
	...
	console.log("autumn");
	document.body.classList.remove(['spring','summer','winter']);
...
spring.addEventListener('click',function(){
	...
	console.log("spring");
	document.body.classList.remove(['winter','summer','autumn']);
...
summer.addEventListener('click',function(){
	...
	console.log("summer");
	document.body.classList.remove(['spring','autumn','winter']);
...
winter.addEventListener('click',function(){
	...
	console.log("winter");
	document.body.classList.remove(['spring','summer','autumn']);
